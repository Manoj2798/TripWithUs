...
function sortHotelLowToHighByPrice(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortHotelHighToLowByPrice(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    results = hotelsCopy.sort(sortHotelLowToHighByPrice);
  } else if (pricing === 'high-to-low') {
    results = hotelsCopy.sort(sortHotelHighToLowByPrice);
  }
  res.json({ hotels: results });
});

// Ascending
function sortHotelLowToHighByRating(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

//Descending
function sortHotelHighToLowByRating(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    results = hotelsCopy.sort(sortHotelLowToHighByRating);
  } else if (rating === 'high-to-low') {
    results = hotelsCopy.sort(sortHotelHighToLowByRating);
  }
  res.json({ hotels: results });
});

// Ascending
function sortHotelLeastToMostByReviews(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

//Descending
function sortHotelMostToLeastByReviews(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    results = hotelsCopy.sort(sortHotelLeastToMostByReviews);
  } else if (reviews === 'most-to-least') {
    results = hotelsCopy.sort(sortHotelMostToLeastByReviews);
  }
  res.json({ hotels: results });
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let results = hotelsCopy.filter((hotel) =>
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let results = hotelsCopy.filter((hotel) => filterByCountry(hotel, country));
  res.json({ hotels: results });
});
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  let results = hotelsCopy.filter((hotel) => filterByCategory(hotel, category));
  res.json({ hotels: results });
});
